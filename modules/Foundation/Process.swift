...
@objc(Process) protocol ProcessExports: JSExport, NSObjectExports {
  ...
  /**
    ...
    - Introduced: 10.13
  */
// jsvalue   @objc @available(OSX 10.13, *) static func launchedTaskWithExecutableURLWithArgumentsWithErrorWithTerminationHandler(_ p0: URL, _ p1: [String], _ `arguments`: UnsafeMutablePointer<Error?>?, _ terminationHandler: JSValue) -> Process?
