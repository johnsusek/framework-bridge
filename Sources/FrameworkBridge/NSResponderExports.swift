...
@objc(NSResponder) protocol NSResponderExports: JSExport, NSObjectExports {
  ...
  */
  @objc func helpRequested(_ p0: NSEvent)

  /**
    - Selector: interpretKeyEvents:
  */
  @objc func interpretKeyEvents(_ p0: [NSEvent])
  ...
  */
  ...
  /**
    ...
    - Introduced: 10.12
  */
  @objc @available(OSX 10.12, *) func newWindowForTab(_ p0: Any?)
  ...
  */
  ...
  /**
    ...
    - Introduced: 10.7
  */
  @objc @available(OSX 10.7, *) func performTextFinderAction(_ p0: Any?)
  ...
  */
  @objc (shouldBeTreatedAsInkEvent:) func shouldBeTreatedAsInkEvent(_ p0: NSEvent) -> Bool

  /**
    - Selector: showContextHelp:
  */
  @objc func showContextHelp(_ p0: Any?)
  ...
  */
  @objc (tryToPerform:with:) func tryToPerform(_ p0: Selector, with: Any?) -> Bool
  ...
  */
  ...
  /**
    ...
    - Introduced: 10.7
  */
  @objc (validateProposedFirstResponder:forEvent:) @available(OSX 10.7, *) func validateProposedFirstResponder(_ p0: NSResponder, `for`: NSEvent?) -> Bool
