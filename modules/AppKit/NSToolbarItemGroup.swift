...
@objc(NSToolbarItemGroup) protocol NSToolbarItemGroupExports: JSExport, NSToolbarItemExports {
  ...
  /**
    ...
    - Introduced: 10.15
  */
  @objc @available(OSX 10.15, *) static func createWithItemIdentifier_Images_SelectionMode_Labels(_ itemIdentifier: NSToolbarItem.Identifier, _ images: [NSImage], _ selectionMode: NSToolbarItemGroup.SelectionMode, _ labels: [String]?) -> Self

  /**
    - Selector: groupWithItemIdentifier:titles:selectionMode:labels:target:action:
    - Introduced: 10.15
  */
  @objc @available(OSX 10.15, *) static func createWithItemIdentifier_Titles_SelectionMode_Labels(_ itemIdentifier: NSToolbarItem.Identifier, _ titles: [String], _ selectionMode: NSToolbarItemGroup.SelectionMode, _ labels: [String]?) -> Self
...
extension NSToolbarItemGroup: NSToolbarItemGroupExports {
  ...
  /**
    ...
    - Introduced: 10.15
  */
  @objc public static func createWithItemIdentifier_Images_SelectionMode_Labels(_ itemIdentifier: NSToolbarItem.Identifier, _ images: [NSImage], _ selectionMode: NSToolbarItemGroup.SelectionMode, _ labels: [String]?) -> Self {
  ...
  /**
    ...
    - Introduced: 10.15
  */
  @objc public static func createWithItemIdentifier_Titles_SelectionMode_Labels(_ itemIdentifier: NSToolbarItem.Identifier, _ titles: [String], _ selectionMode: NSToolbarItemGroup.SelectionMode, _ labels: [String]?) -> Self {
