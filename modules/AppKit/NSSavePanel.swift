...
@objc(NSSavePanel) protocol NSSavePanelExports: JSExport, NSPanelExports {
  ...
  */
  ...
  /**
    ...
    - Introduced: 10.6
  */
  // jsvalue @objc @available(OSX 10.6, *) func beginSheetModalForWindowWithCompletionHandler(`for`: NSWindow, completionHandler: JSValue)

  /**
    - Selector: beginWithCompletionHandler:
    - Introduced: 10.6
  */
  // jsvalue @objc @available(OSX 10.6, *) func beginWithCompletionHandler(completionHandler: JSValue)
