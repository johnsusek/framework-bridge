...
@objc(NSCollectionView) protocol NSCollectionViewExports: JSExport, NSViewExports {
  ...
  */
  ...
  /**
    ...
    - Introduced: 10.11
  */
  // jsvalue @objc @available(OSX 10.11, *) func performBatchUpdatesWithCompletionHandler(_ completionHandler: JSValue, completionHandler completionHandler1: JSValue)
