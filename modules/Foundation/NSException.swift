...
@objc(NSException) protocol NSExceptionExports: JSExport, NSObjectExports {
  ...
  */
  @objc static func createWithName_Reason_UserInfo(_ name: NSExceptionName, _ reason: String?, _ userInfo: [AnyHashable: Any]?) -> NSException
...
extension NSException: NSExceptionExports {
  ...
  /**
    - Selector: exceptionWithName:reason:userInfo:
  */
  @objc public static func createWithName_Reason_UserInfo(_ name: NSExceptionName, _ reason: String?, _ userInfo: [AnyHashable: Any]?) -> NSException {
