...
@objc(NSData) protocol NSDataExports: JSExport, NSObjectExports {
  ...
  */
  // @objc static func createWithContentsOfFileOptions(_ options: String, _ error: NSData.ReadingOptions) -> Self?
  ...
  */
  // @objc static func createWithContentsOfURLOptions(_ options: URL, _ error: NSData.ReadingOptions) -> Self?
  ...
  */
  // @objc (getBytes:length:) func copyBytes(to: UnsafeMutableRawPointer, count: Int)

  /**
    - Selector: getBytes:range:
  */
  // @objc (getBytes:range:) func copyBytes(to: UnsafeMutableRawPointer, from: NSRange)
  ...
  */
  // throws - @objc func writeToFile(options: String, error: NSData.WritingOptions) -> Bool
  ...
  */
  // throws - @objc func writeToURL(options: URL, error: NSData.WritingOptions) -> Bool
...
extension NSData: NSDataExports {
  ...
  */
  ...
  /**
    - Selector: dataWithContentsOfFile:options:error:
  */
  // @objc public static func createWithContentsOfFileOptions(_ options: String, _ error: NSData.ReadingOptions) -> Self? {
  //   return try? self.dataWithContentsOfFile(options, error)
  // }
  ...
  */
  ...
  /**
    - Selector: dataWithContentsOfURL:options:error:
  */
  // @objc public static func createWithContentsOfURLOptions(_ options: URL, _ error: NSData.ReadingOptions) -> Self? {
  //   return try? self.dataWithContentsOfURL(options: options, error: error)
  // }
