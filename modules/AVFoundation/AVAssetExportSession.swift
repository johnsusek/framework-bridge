...
@objc(AVAssetExportSession) protocol AVAssetExportSessionExports: JSExport, NSObjectExports {
  ...
  */
  ...
  /**
    ...
    - Introduced: 10.9
  */
// jsvalue   @objc @available(OSX 10.9, *) static func determineCompatibilityOfExportPresetWithAssetWithOutputFileTypeWithCallback(_ ofExportPreset: String, _ with: AVAsset, _ outputFileType: AVFileType?, _ completionHandler: JSValue)
  ...
  */
  ...
  /**
    ...
    - Introduced: 10.9
  */
  // jsvalue @objc @available(OSX 10.9, *) func determineCompatibleFileTypesWithCallback(_ completionHandler: JSValue)

  /**
    - Selector: estimateMaximumDurationWithCompletionHandler:
    - Introduced: 10.15
  */
  // jsvalue @objc @available(OSX 10.15, *) func estimateMaximumDurationWithCallback(_ completionHandler: JSValue)

  /**
    - Selector: estimateOutputFileLengthWithCompletionHandler:
    - Introduced: 10.15
  */
  // jsvalue @objc @available(OSX 10.15, *) func estimateOutputFileLengthWithCallback(_ completionHandler: JSValue)

  /**
    - Selector: exportAsynchronouslyWithCompletionHandler:
  */
  // jsvalue @objc func exportAsynchronouslyWithCallback(_ completionHandler: JSValue)
