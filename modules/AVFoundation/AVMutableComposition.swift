...
@objc(AVMutableComposition) protocol AVMutableCompositionExports: JSExport, AVCompositionExports {
  ...
  /**
    ...
    - Introduced: 10.11
  */
  @objc @available(OSX 10.11, *) static func createWithCompositionWithURLAssetInitializationOptions(_ urlAssetInitializationOptions: [String: Any]?) -> Self
...
extension AVMutableComposition: AVMutableCompositionExports {
  ...
  /**
    ...
    - Introduced: 10.11
  */
  @objc public static func createWithCompositionWithURLAssetInitializationOptions(_ urlAssetInitializationOptions: [String: Any]?) -> Self {
